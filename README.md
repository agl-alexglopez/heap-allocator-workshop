...
> **Notice:** This repository contains **NO heap allocator implementation that I submitted for CS107 at Stanford University**. All implementations are original and written in my own free time, with sources cited when appropriate. The data structures and algorithms far exceed the requirements and complexity of any introductory classes of which I am aware, limiting their helpfulness in implementing one's own first allocator. This is simply an exploration of the tradeoffs in heap allocator implementations. Please contact me if you feel otherwise. I hope you enjoy! 
