/**
 * File rbtree_topdown_utility.c
 * ---------------------------------
 * This file contains the implementation of utility functions for the rbtree_topdown heap
 ...
 * algorithm implementations in the actual rbtree_topdown.c file so we seperate them out here.
 */
#include <limits.h>
#include <stdlib.h>
