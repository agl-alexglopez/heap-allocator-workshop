/**
 * File rbtree_linked_utility.c
 * ---------------------------------
 * This file contains the implementation of utility functions for the rbtree_linked heap
 * allocator. These functions serve as basic navigation for nodes and blocks. These functions can
