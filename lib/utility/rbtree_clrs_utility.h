/**
 * File: rbtree_clrs_utility.h
 * ---------------------------------
 * This file contains the interface that defines our custom types for the rbtree_clrs
 ...
 */
#ifndef RBTREE_CLRS_UTILITY_H
#define RBTREE_CLRS_UTILITY_H
#include <stddef.h>
#include <stdbool.h>
