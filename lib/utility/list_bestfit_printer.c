 ...
 * ----------------------------
 * This file contains my implementation of the list printing functions. These are helpful to view
 * the status of the heap and pair well with gdb. One of these functions is used to show the free
