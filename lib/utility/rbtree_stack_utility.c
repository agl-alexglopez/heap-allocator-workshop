/**
 * File rbtree_stack_utility.c
 * ---------------------------------
 * This file contains the implementation of utility functions for the rbtree_stack heap
 ...
 * algorithm implementations in the actual rbtree_stack.c file so we seperate them out here.
 */
#include <limits.h>
#include <stdlib.h>
