/**
 * File: rbtree_clrs_tests.c
 * -------------------------
 * This file contains the interface for the tests for the rbtree_clrs allocator.
 * The number of tests grows for the tree allocators due to the risks of
 * incorrectly rotating a Red Black Tree.
 */
