/**
 * File: rbtree_linked_utilities.h
 * -----------------------------------
 ...
 *   |        |        |        |        |        |        |        |        |
 * |        | |        |red     |left    |free    |        |        |        |
 * |        |        | |size_t  |or      |neighbor|or      |*parent
 * |links[L]|links[R]|*list   |...     |footer  | |bytes   |black   |status
 * |alloc   |        |        |        | start  |        |        | |        |
 * |        |        |        |        |        |        |        |        |
 *   +--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+
 ...
 */
#ifndef RBTREE_LINKED_UTILITIES_H
#define RBTREE_LINKED_UTILITIES_H
...
// When you see these, know that we are working with a doubly linked list, not a
// tree.
 ...
 * black.
 * @return            a pointer to the minimum node in a valid binary search
 * tree.
 */
