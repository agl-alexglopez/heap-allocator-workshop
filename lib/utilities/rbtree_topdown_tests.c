/**
 * File: rbtree_topdown_tests.c
 * --------------------------
 * This file contains the test implementation for the rbtree_topdown allocator.
 * These tests are most helpful for the test_harness program and to use in gdb.
 * If a failing test is run in gdb it will automatically activate a breakpoint
 * on the failing stackframe so we can see what went wrong.
 */
