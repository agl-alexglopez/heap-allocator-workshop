 ...
 * lives on the heap.
 *  - Every path from root to free.black_nil, root not included, has same number
 * of black nodes.
 ...
 * @param *black_nil  the sentinel node sitting at the bottom of the tree. It is
 * always black.
 * @param *path[]     the stack we are using to track tree lineage and
 * rotations.
 * @param *path_len   the length of the path we update as we get the tree
 * minimum.
