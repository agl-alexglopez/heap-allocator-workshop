/**
 * File: rbtree_unified_printer.c
 * ------------------------------
 * This file contains the printing implementation for the rbtree_unified
 * allocator. They are most helpful while debugging in gdb but one function is
 * used for visualizations in the print_peaks program.
 */
