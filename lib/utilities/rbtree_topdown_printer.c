/**
 * File: rbtree_topdown_printer.c
 * ----------------------------
 * This file contains the printing utilities for the rbtree_topdown allocator.
 * These are most helpful while debugging in gdb. However, we use one of these
 * functions to help visualize the heap in the print_peaks program.
 */
