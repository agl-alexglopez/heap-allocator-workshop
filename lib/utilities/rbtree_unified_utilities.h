/**
 * File: rbtree_unified_utilities.h
 * -----------------------------------
 * This file contains the interface for defining the types, methods, tests and
 * printing functions for the rbtree_unified allocator. It is helpful to
 ...
 * either in our tree.
 */
#ifndef RBTREE_UNIFIED_UTILITIES_H
#define RBTREE_UNIFIED_UTILITIES_H
 ...
 * lives on the heap.
 *  - Every path from root to tree.black_nil, root not included, has same number
 * of black nodes.
