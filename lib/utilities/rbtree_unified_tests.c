 ...
 * ----------------------------
 * This file contains the interface defining the tests for the rbtree_unified
 * allocator. These will help discover what operations on the tree may be
 * failing. If run in gdb the failing test will set a break point and stop
 * execution in the stack frame that the error occured in the test.
 */
 ...
 * is always black.
 * @param total_free_mem       the previously calculated free memory from a
 * linear heap search.
