...
static void print_rb_tree( const struct rb_node *root, void *nil_and_tail, print_style style );
...
static void print_node( const struct rb_node *root, void *nil_and_tail, print_style style )
{
