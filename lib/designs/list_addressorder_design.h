 ...
 * the allocator algorithm, but helpful in its development. All methods are inlined because they
 * are one to two line operations and the two line operations have the extra line for readability.
 * This way the compiler can choose to put them inline in the algorithms, especially in "hot-spot"
 * functions.
 *
