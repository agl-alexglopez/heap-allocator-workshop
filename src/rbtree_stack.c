 ...
 */
static rb_node *get_min(rb_node *root, rb_node *path[], int *path_len) {
 ...
 */
static void init_footer(const rb_node *node, size_t payload) {
 ...
 */
static void print_error_block(rb_node *node, size_t block_size) {
